            ...
            <div className="grid grid-cols-5 gap-6">
              <div className="col-span-3 p-6 rounded-2xl border bg-accent/50">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { label: 'Backend API Refactor', time: '14:00', color: '#10b981', done: false },
                  ].map((task, i) => (
              ...
              <div className="col-span-2 space-y-6">
                <div className="p-6 rounded-2xl border bg-white shadow-sm flex flex-col items-center justify-center text-center">
                   <h4 className="text-[11px] font-bold uppercase tracking-widest text-muted mb-4">Productivity Score</h4>
                ...
                <div className="p-5 rounded-2xl border bg-primary text-white shadow-lg shadow-primary/20">
                   ...
                   <p className="text-[10px] opacity-90 leading-tight">Looks like you have a gap at 3 PM. Schedule a review task?</p>
                </div>
              </div>
            </div>
          </div>
